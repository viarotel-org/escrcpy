...
📱 使用图形界面的 Scrcpy 显示和控制您的 Android 设备，由 Electron 驱动。[更多截图](https://github.com/viarotel-org/escrcpy/tree/main/screenshots) | [English](https://github.com/viarotel-org/escrcpy/blob/main/README-CN.md)
