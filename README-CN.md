...
<div style="display:flex;">
  <img src="https://cdn.jsdelivr.net/gh/viarotel/resources@latest/screenshots/escrcpy/zh-CN/overview.png" alt="viarotel-escrcpy" width="100%">
</div>

## 特点

- 🤖 **智能控制**：基于 AutoGLM 的自然语言命令，可智能控制 Android 设备
- 🏃 **自动化与效率**：支持跨多个设备并行操作的自动化工作流执行
- 🪟 **多设备管理**：可视化窗口编排，集中管理多个设备
- 📡 **连接与网络**：支持 Gnirehtet 反向网络共享的无线连接
- ⚡ **Scrcpy核心**：基于 Scrcpy 的高性能、低延迟屏幕镜像
