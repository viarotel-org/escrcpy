...
30. Поддержка добавления открытого приложения на ярлык рабочего стола (только для Windows) ✅
31. Поддержка пакетного запуска устройств ✅
32. Улучшен способ установки положения и размера зеркального окна 🚧
33. Улучшен опыт пакетного подключения устройств 🚧
34. Поддержка графического инструмента редактирования скриптов 🚧
