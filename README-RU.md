<div style="display:flex;">
  <img src="https://cdn.jsdelivr.net/gh/viarotel-org/escrcpy@main/electron/resources/build/logo.png?version=2.0.0" alt="viarotel-escrcpy" width="108px">
</div>
...
- 🤖 **Интеллектуальное управление**: Управление Android-устройствами с помощью естественных языковых команд на базе **AutoGLM**
- 🏃 **Автоматизация и эффективность**: Автоматическое выполнение процессов с поддержкой параллельной работы на нескольких устройствах
- 🪟 **Управление несколькими устройствами**: Визуальная организация окон и централизованное управление несколькими устройствами
- 📡 **Подключение и сеть**: Беспроводное подключение и поддержка обратного интернет-доступа через **Gnirehtet**
- ⚡ **Ядро Scrcpy**: Высокопроизводительное зеркалирование экрана с низкой задержкой на базе Scrcpy
