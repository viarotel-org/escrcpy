...
<div style="display:flex;">
  <img src="https://cdn.jsdelivr.net/gh/viarotel/resources@latest/screenshots/escrcpy/ru-RU/overview.png?version=3.0.8" alt="viarotel-escrcpy" width="100%">
</div>
...
- 🤖 **Aссистент**: AI-ассистент на основе MCP-протокола для интеллектуального управления Android-устройствами с поддержкой мультимодельного чата
- 🏃 **Автоматизация скриптов**: Визуальный пошаговый оркестратор рабочих процессов с распознаванием изображений на экране и пакетным выполнением на нескольких устройствах
...
- 🔑 **Управление горячими клавишами**: Настраиваемые глобальные горячие клавиши для быстрых операций с устройствами
