...
<div style="display:flex;">
  <img src="https://cdn.jsdelivr.net/gh/viarotel-org/escrcpy@main/screenshots/ru-RU/overview.jpg" alt="viarotel-escrcpy" width="100%">
</div>
...
1. Ручная установка через выпущенные пакеты

[Просмотреть адрес выпуска](https://github.com/viarotel-org/escrcpy/releases)

2. macOS можно установить через Homebrew
...
- Gnirehtet
- Группа зеркалирования (отказаться)
...
26. Улучшен опыт подключения истории устройств 🚧
27. Управление файлами поддерживает каталог загрузки и отображение прогресса 🚧
28. Группировка устройств 🚧
29. Карта клавиш для игр 🚧
