/**
 * Schedule-related dictionary configuration
 *
...
export const timerType = [
  {
    label: 'device.schedule.frequency.timeout',
    value: 'timeout',
  },
  {
    label: 'device.schedule.frequency.interval',
    value: 'interval',
  },
  {
    label: 'device.schedule.frequency.cron',
    value: 'cron',
  },
]
