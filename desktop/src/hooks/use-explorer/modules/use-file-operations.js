...
import { sortFileList } from './use-file-sort.js'
...
export function useFileOperations({ deviceId, currentPath }) {
  ...
  /** @type {import('vue').Ref<import('../types.js').SortOptions>} Sort configuration */
  const sortOptions = ref(/** @type {import('../types.js').SortOptions} */ ({
    sortBy: 'name',
    directoryFirst: true,
    direction: 'asc',
  }))
  ...
  async function readDirectory() {
    ...
    try {
      ...
      files.value = sortFileList(data, sortOptions.value)
