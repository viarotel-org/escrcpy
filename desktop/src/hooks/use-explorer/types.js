...
/**
 * Sort field
 * @typedef {'name' | 'size' | 'updateTime'} SortField
 */
 ...
 * @property {SortField} [sortBy='name'] - Field to sort by
 * @property {boolean} [directoryFirst=true] - Whether directories appear before files
 * @property {SortDirection} [direction='asc'] - Sort direction
 */
 ...
 * @property {FileEntryType} type - Entry type (recent only allows 'directory')
 * @property {string} parentPath - Parent path
 * @property {boolean} favorite - Whether this item is favorited
 * @property {number|null} visitedAt - Timestamp of last visit, null if never visited
 * @property {number} createdAt - Timestamp of creation
 * @property {number} order - Sort order field (reserved for drag sorting)
 */
