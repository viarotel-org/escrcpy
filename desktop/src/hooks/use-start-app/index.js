...
import { mergePreferenceConfig } from '$/store/preference/helpers/index.js'
...
export function useStartApp() {
  ...
  async function resolveScrcpyRuntime({ deviceId, userId, appName, landscape, shouldCreateNewDisplay, packageName }) {
    ...
    const mergedConfig = mergePreferenceConfig(deviceConfig, launchConfig)
    ...
    const commands = preferenceStore.scrcpyParameter(mergedConfig, {
      excludes: ['--new-display', '--power-off-on-close'],
