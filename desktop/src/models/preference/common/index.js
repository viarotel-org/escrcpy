...
export default {
  ...
  children: {
    ...
    environmentVariables: {
      label: 'preferences.common.environmentVariables.name',
      field: 'environmentVariables',
      value: undefined,
      type: 'Input',
      placeholder: 'preferences.common.environmentVariables.placeholder',
      tips: 'preferences.common.environmentVariables.tips',
      span: 24,
      props: {
        type: 'textarea',
        autosize: true,
