...
此应用通过USB或[TCP/IP](/zhHans/reference/scrcpy/connection#tcpip-wireless)连接镜像Android设备（视频和音频），并支持使用计算机的键盘和鼠标进行控制。它不需要*root*权限，也无需在设备上安装应用。支持*Linux*、*Windows*和*macOS*。
